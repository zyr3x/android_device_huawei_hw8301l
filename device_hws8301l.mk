...
#$(call inherit-product-if-exists, vendor/huawei/hws8301l/hws8301l-vendor.mk)

LOCAL_PATH := device/huawei/hws8301l
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/recovery/fstab.hws8301l:root/fstab.hws8301l \
    $(LOCAL_PATH)/root/init.hws8301l.rc:root/init.hws8301l.rc \
    $(LOCAL_PATH)/root/init.usb.rc:root/init.usb.rc \
    $(LOCAL_PATH)/root/init.hws8301l.cpu.rc:root/init.hws8301l.cpu.rc \
    $(LOCAL_PATH)/root/init.hws8301l.glove.rc:root/init.hws8301l.glove.rc \
    $(LOCAL_PATH)/recovery/ueventd.hws8301l.rc:root/ueventd.hws8301l.rc \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/recovery/ueventd.hws8301l.rc:recovery/root/ueventd.hws8301l.rc \
    $(LOCAL_PATH)/recovery/fstab.hws8301l:recovery/root/fstab.hws8301l \
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.product.model=MDEIAPAD M1 8.0
